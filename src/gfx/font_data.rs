// src/gfx/font_data.rs
//
// Tabela de glifos bitmap 8×8, ASCII 0x20 (espaço) a 0x7F (bloco).
// 96 glifos × 8 bytes = 768 bytes total.
//
// Formato: 1 bit por pixel, MSB = pixel mais à esquerda.
// Inspirada na fonte ZX Spectrum (domínio público).
...
pub static FONT_8X8: [u8; 768] = [
    ...
    // 0x25 %
    0x00,0x60,0x64,0x08,0x10,0x26,0x06,0x00,
    // 0x26 &
    ...
    // 0x33 3
    0x00,0x7C,0x08,0x10,0x08,0x44,0x38,0x00,
    // 0x34 4
    0x00,0x08,0x18,0x28,0x48,0x7C,0x08,0x00,
    // 0x35 5
    0x00,0x7C,0x40,0x78,0x04,0x44,0x38,0x00,
    // 0x36 6
    0x00,0x18,0x20,0x78,0x44,0x44,0x38,0x00,
    // 0x37 7
    0x00,0x7C,0x04,0x08,0x10,0x10,0x10,0x00,
    // 0x38 8
    ...
    // 0x40 @
    0x00,0x3C,0x44,0x5C,0x54,0x5C,0x40,0x3C,
    // 0x41 A
    0x00,0x10,0x28,0x44,0x7C,0x44,0x44,0x00,
    // 0x42 B
    ...
    // 0x52 R
    0x00,0x78,0x44,0x44,0x78,0x44,0x44,0x00,
    // 0x53 S
    0x00,0x38,0x44,0x30,0x08,0x44,0x38,0x00,
    // 0x54 T
    ...
    // 0x66 f
    0x00,0x18,0x20,0x70,0x20,0x20,0x20,0x00,
    // 0x67 g
    ...
    // 0x6B k
    0x00,0x40,0x48,0x50,0x60,0x50,0x48,0x00,
    // 0x6C l
    ...
    // 0x72 r
    0x00,0x00,0x58,0x24,0x20,0x20,0x20,0x00,
    // 0x73 s
    0x00,0x00,0x38,0x40,0x38,0x04,0x78,0x00,
    // 0x74 t
    0x00,0x10,0x7C,0x10,0x10,0x14,0x08,0x00,
    // 0x75 u
    0x00,0x00,0x44,0x44,0x44,0x44,0x38,0x00,
    // 0x76 v
    0x00,0x00,0x44,0x44,0x28,0x28,0x10,0x00,
    // 0x77 w
    0x00,0x00,0x44,0x54,0x54,0x6C,0x44,0x00,
    // 0x78 x
    ...
    // 0x7B {
    0x00,0x0C,0x10,0x30,0x10,0x10,0x0C,0x00,
    // 0x7C |
    0x00,0x10,0x10,0x10,0x10,0x10,0x10,0x00,
    // 0x7D }
    0x00,0x30,0x08,0x0C,0x08,0x08,0x30,0x00,
    // 0x7E ~
